...
public class PortableBackpackGUI3Gui extends XIndustryModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;

	public PortableBackpackGUI3Gui(XIndustryModElements instance) {
		super(instance, 51);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("portable_backpack_gui_3"));
		}
	}

	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, PortableBackpackGUI3GuiWindow::new));
	}
