...
public class PortableBackpackGUI2GuiWindow extends ContainerScreen<PortableBackpackGUI2Gui.GuiContainerMod> {
	...
	public void init(Minecraft minecraft, int width, int height) {
		...
		this.addButton(new Button(this.guiLeft + 8, this.guiTop + 60, 46, 20, new StringTextComponent("�ص���ҳ"), e -> {
			if (true) {
		...
		this.addButton(new Button(this.guiLeft + 125, this.guiTop + 61, 40, 20, new StringTextComponent("��һҳ"), e -> {
			if (true) {
