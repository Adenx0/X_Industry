...
public class MachineBaseBlock extends XIndustryModElements.ModElement {
	@ObjectHolder("x_industry:machine_base")
	public static final Block block = null;

	public MachineBaseBlock(XIndustryModElements instance) {
		super(instance, 59);
	}
