...
public class TongKuaiBlock extends XIndustryModElements.ModElement {
	@ObjectHolder("x_industry:copper_block")
	public static final Block block = null;

	public TongKuaiBlock(XIndustryModElements instance) {
		super(instance, 2);
	}
