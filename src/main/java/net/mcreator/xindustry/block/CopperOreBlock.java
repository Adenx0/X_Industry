...
import net.mcreator.xindustry.item.RawCopperItem;
...
public class CopperOreBlock extends XIndustryModElements.ModElement {
	@ObjectHolder("x_industry:copper_ore")
	public static final Block block = null;

	public CopperOreBlock(XIndustryModElements instance) {
		super(instance, 3);
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.METAL).hardnessAndResistance(3.5f, 10f).setLightLevel(s -> 0).harvestLevel(1)
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(RawCopperItem.block));
		}
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("x_industry:copper_ore_match"), () -> CustomRuleTest.codec);
