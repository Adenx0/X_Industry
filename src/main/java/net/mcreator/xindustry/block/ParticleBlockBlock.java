...
public class ParticleBlockBlock extends XIndustryModElements.ModElement {
	@ObjectHolder("x_industry:particle_block")
	public static final Block block = null;

	public ParticleBlockBlock(XIndustryModElements instance) {
		super(instance, 38);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("particle_block");
		}
