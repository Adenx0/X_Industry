...
public class AchievementCompletorBlock extends XIndustryModElements.ModElement {
	@ObjectHolder("x_industry:achievement_completor")
	public static final Block block = null;

	public AchievementCompletorBlock(XIndustryModElements instance) {
		super(instance, 53);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("achievement_completor");
		}
