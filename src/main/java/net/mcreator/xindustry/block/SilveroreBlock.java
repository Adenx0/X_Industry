...
import net.mcreator.xindustry.item.SilverItem;
...
public class SilveroreBlock extends XIndustryModElements.ModElement {
	@ObjectHolder("x_industry:silverore")
	public static final Block block = null;

	public SilveroreBlock(XIndustryModElements instance) {
		super(instance, 19);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("x_industry:silverore_match"), () -> CustomRuleTest.codec);
