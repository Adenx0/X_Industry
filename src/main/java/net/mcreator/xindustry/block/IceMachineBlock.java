...
public class IceMachineBlock extends XIndustryModElements.ModElement {
	@ObjectHolder("x_industry:ice_machine")
	public static final Block block = null;

	public IceMachineBlock(XIndustryModElements instance) {
		super(instance, 33);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void neighborChanged(BlockState blockstate, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos, boolean moving) {
			...
			if (world.getRedstonePowerFromNeighbors(new BlockPos(x, y, z)) > 0) {
				...
				IceMachineHongShiDianYuanKaiQiShiProcedure.executeProcedure(Stream
