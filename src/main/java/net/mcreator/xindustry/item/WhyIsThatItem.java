...
public class WhyIsThatItem extends XIndustryModElements.ModElement {
	@ObjectHolder("x_industry:why_is_that")
	public static final Item block = null;

	public WhyIsThatItem(XIndustryModElements instance) {
		super(instance, 54);
	}
