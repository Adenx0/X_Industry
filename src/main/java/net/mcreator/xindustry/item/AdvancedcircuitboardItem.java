...
public class AdvancedcircuitboardItem extends XIndustryModElements.ModElement {
	@ObjectHolder("x_industry:advancedcircuitboard")
	public static final Item block = null;

	public AdvancedcircuitboardItem(XIndustryModElements instance) {
		super(instance, 21);
	}
