...
public class ParticleSynthesizerItem extends XIndustryModElements.ModElement {
	@ObjectHolder("x_industry:particle_synthesizer")
	public static final Item block = null;

	public ParticleSynthesizerItem(XIndustryModElements instance) {
		super(instance, 36);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("particle_synthesizer");
		}
