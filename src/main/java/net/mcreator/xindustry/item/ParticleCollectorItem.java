...
import net.mcreator.xindustry.procedures.ParticleCollectorDangWuPinZaiShouShangMeiKeFaShengProcedure;
...
public class ParticleCollectorItem extends XIndustryModElements.ModElement {
	@ObjectHolder("x_industry:particle_collector")
	public static final Item block = null;

	public ParticleCollectorItem(XIndustryModElements instance) {
		super(instance, 34);
	}
	...
	public static class ItemCustom extends Item {
		...
		public void inventoryTick(ItemStack itemstack, World world, Entity entity, int slot, boolean selected) {
			...
			if (selected)
				...
				ParticleCollectorDangWuPinZaiShouShangMeiKeFaShengProcedure.executeProcedure(Stream
