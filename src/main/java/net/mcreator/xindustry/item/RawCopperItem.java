...
public class RawCopperItem extends XIndustryModElements.ModElement {
	@ObjectHolder("x_industry:raw_copper")
	public static final Item block = null;

	public RawCopperItem(XIndustryModElements instance) {
		super(instance, 3);
	}
